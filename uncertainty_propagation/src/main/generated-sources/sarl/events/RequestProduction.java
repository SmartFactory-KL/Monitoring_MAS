...
public class RequestProduction extends Event {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    RequestProduction other = (RequestProduction) obj;
    if (other.uc != this.uc)
      return false;
  ...
  /**
   * Returns a String representation of the RequestProduction event's attributes only.
   */
  @SyntheticMember
  @Pure
